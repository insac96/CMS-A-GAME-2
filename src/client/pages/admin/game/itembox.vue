...
const getList = async () => {
  try {
    ...
    const data = await useAPI('item/admin/box/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('item/admin/box/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('item/admin/box/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('item/admin/box/del', { _id })
