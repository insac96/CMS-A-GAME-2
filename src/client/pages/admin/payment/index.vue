...
const getList = async () => {
  try {
    ...
    const data = await useAPI('payment/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const successAction = async () => {
  try {
    ...
    await useAPI('payment/admin/verify', JSON.parse(JSON.stringify(stateSuccess.value)))
...
const refuseAction = async () => {
  try {
    ...
    await useAPI('payment/admin/verify', JSON.parse(JSON.stringify(stateRefuse.value)))
